...
public class MenuBuilder {
	...
	public static String createMenu(String user_id, Connection conn, String login_user) {
		...
		//	sb.append("	           <a style='COLOR: #fff;text-decoration: underline;' href='javascript:void(0)' onclick=\"wx_winpage('ShowReport.wx?PAGEID=change_password',{title:'我的密码',lock:true,width:500,height:260})\" target='_BLANK'>修改我的密码</a>");
